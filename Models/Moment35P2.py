...
from MomentGauge.Statistic.PolyStatistics import Maxwellian_1D_stats,M35_P2_1D_stats
from MomentGauge.Statistic.PolyGaugedStatistics import PolyGaugedStatistics, M35_1D_gauged_stats, M35_P2_1D_gauged_stats
...
class M35_P2_Gauged_Legendre_1D(GaugedExpFamilyModel,BaseExpFamilyModel):
    def __init__(self, constant):
        r"""The exponential family distribution model for M35P2 gauged statistics.
        ...
        self._statistics = M35_P2_1D_gauged_stats()
    ...
    def moments_to_natural_paras(self, betas_ini, moments, gauge_paras, domain):
        ...
        Parameters
        ----------
        betas_ini : float array of shape (11)
            A set of proposed natural parameter :math:`\boldsymbol{\beta}`
        moments : float array of shape (11)
        ...
        Tuple
            A tuple containing
                ...
                **beta**: *float array of shape (11)* - The natural parameters :math:`\boldsymbol{\beta}`
...
class M35_P2_Gauged_Canonical_Legendre_1D(M35_P2_Gauged_Legendre_1D,CanonicalExpFamilyModel):
    def __init__(self, constant):
